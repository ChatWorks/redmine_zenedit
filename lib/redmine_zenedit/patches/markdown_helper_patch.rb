...
unless Redmine::WikiFormatting::Markdown::Helper.included_modules.include?(RedmineZenedit::Patches::MarkdownHelperPatch)
  Redmine::WikiFormatting::Markdown::Helper.send(:include, RedmineZenedit::Patches::MarkdownHelperPatch)
end
